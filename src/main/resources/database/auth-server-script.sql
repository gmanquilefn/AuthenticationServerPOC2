...
CREATE TABLE public.users_authorities (
	...
	CONSTRAINT users_authorities_users_fk FOREIGN KEY (user_id) REFERENCES public.users(user_id),
	CONSTRAINT users_authorities_authorities_fk FOREIGN KEY (authority_id) REFERENCES public.authorities(authority_id)
);
...
CREATE TABLE public.authorizationConsent (
    registeredClientId varchar(255) NOT NULL,
    principalName varchar(255) NOT NULL,
