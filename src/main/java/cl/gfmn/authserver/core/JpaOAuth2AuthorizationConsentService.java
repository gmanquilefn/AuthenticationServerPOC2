package cl.gfmn.authserver.core;

import cl.gfmn.authserver.core.entity.AuthorizationConsent;
import cl.gfmn.authserver.core.repository.AuthorizationConsentRepository;
...
/**
 * https://docs.spring.io/spring-authorization-server/docs/current/reference/html/guides/how-to-jpa.html#authorization-consent-service
 */
@Component
